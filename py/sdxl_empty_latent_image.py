...
class RgthreeSDXLEmptyLatentImage:
    ...
    def INPUT_TYPES(cls):
        return {
            "required": {
                ...
                "clip_scale": ("FLOAT", {"default": 2.0, "min": 1.0, "max": 10.0, "step": .5}),
    ...
    # def generate(self, dimensions, clip_scale, batch_size, custom_width=1024, custom_height=1024):
    def generate(self, dimensions, clip_scale, batch_size):
        ...
        return (latent, int(width * clip_scale), int(height * clip_scale),)